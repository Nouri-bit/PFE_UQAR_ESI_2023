...
function TrendDec({navigation, route}) {
 ...
 var prenoms=[]
  ...
  useEffect (()=>{
    ...
    return (
      ...
      <Text style={styles.compte}>Déclarations</Text>
      <View style={styles.rectangle3}>
          <Pressable style={styles.subtitle} onPress={()=> navigation.navigate("all")}>
          <Text style={styles.subtitle}>Tous</Text>
          </Pressable>
          <Pressable style={styles.subtitle} onPress={()=> navigation.navigate("Trend")}>
     ...
     (typeof backendData.posts ==='undefined') ? (
        ...
        backendData.posts.map(({_id, contenu, userType, userId, datedeclaration, like, dislike, commentaires}, i) =>
        (
      ...
      <SafeAreaView style={styles.groupe13} >
          <Image style={styles.masqueImage} source={require('../../assets/user.png')} /><SafeAreaView>
                ...
                <Text style={styles.subtitle}>{datedeclaration}</Text>
            </SafeAreaView>
            ...
            <SafeAreaView style={styles.groupe14}>
                   ...
                   <Text style={styles.subtitlen}>{userType} </Text>
